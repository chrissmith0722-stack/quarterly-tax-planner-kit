...
- [ ] Roll YTD expenses into `schedule-c-categories.csv` labels (or Sheets tab)
- [ ] Update `income-by-source.csv` for the quarter just ended
- [ ] Post mileage log totals into Car and truck (or keep separate for CPA)
...
## 3. Pay & record
- [ ] Pay federal via IRS Direct Pay / EFTPS; save confirmation
- [ ] Pay state via state portal; save confirmation
- [ ] Log both in `quarterly-payments-log.csv`
- [ ] Move cash from operating account → already-reserved tax lockbox was used (or top up lockbox)
